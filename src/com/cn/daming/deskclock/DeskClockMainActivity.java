...
public class DeskClockMainActivity extends Activity implements OnItemClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        device_name = getIntent().getStringExtra("device");
        socket =  getIntent().getIntExtra("socket", 0);
        //取自定义布局的LayoutInflater
        mFactory = LayoutInflater.from(this);
        //取getSharedPreferences中key==“AlarmClock”的值
        mPrefs = getSharedPreferences(PREFERENCES, 0);
        //获取闹钟的cursor
        mCursor = Alarms.getAlarmsCursorByname(getContentResolver(),device_name);
    ...
    private void updateLayout() {
        ...
        title_device_name = (TextView)findViewById(R.id.device_name_title);
    ...
    private void addNewAlarm() {
    	System.out.println("addNewAlarm ============");
    	Intent i = new Intent(this, SetAlarm.class);
    	i.putExtra("device", this.device_name);
    	   i.putExtra("socket", socket);
    	startActivity(i);
    }
