...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      String oldtable = intent.getStringExtra("wokingtable") ;
		...
		if (!oldtable.equals(wokingtable)) {
            Log.v("wangxianming", "Alarm Reciver time mode is not the same== return");
            return ;
		}
...
//        String wokingtable = intent.getStringExtra("wokingtable") ;
//        playAlarm.putExtra("wokingtable", wokingtable);
//		System.out.println("AlarmRecvier get intent wokingtable: "+wokingtable);
