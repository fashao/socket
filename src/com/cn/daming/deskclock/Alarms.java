...
public class Alarms {
	...
	public static void addSocket(Context context, Alarm alarm) {
	...
	public static Cursor getAlarmsCursor(ContentResolver contentResolver) {
		return contentResolver.query(Alarm.Columns.CONTENT_URI,
				...
				Alarm.Columns.SORT_ID_ORDER);
	}

	public static Cursor getAlarmsCursorbytable(
			ContentResolver contentResolver, String table,String oldtable) {
		PreferencesUtils.putString("wokingtable", table);
		Cursor cursor = contentResolver.query(Alarm.Columns.CONTENT_URI,
				Alarm.Columns.ALARM_QUERY_COLUMNS, null, null,
				Alarm.Columns.SORT_ID_ORDER);
		PreferencesUtils.putString("wokingtable", oldtable);

		return cursor;
	}

	public static Cursor getAlarmsCursorOrderByID(
	...
	public static Cursor getAlarmsCursorByname(ContentResolver contentResolver,
			String devicename) {
		return contentResolver.query(Alarm.Columns.CONTENT_URI,
				Alarm.Columns.ALARM_QUERY_COLUMNS, "message=?",
				new String[] { devicename }, Alarm.Columns.SORT_ID_ORDER);
	}
	...
	private static ContentValues createContentValues(Alarm alarm) {
		...
		values.put(Alarm.Columns.FLAG, alarm.flag);
		values.put(Alarm.Columns.SOCKET, alarm.socket);
	...
	private static void enableAlert(Context context, final Alarm alarm,
		...
		if (true) {
			Log.v("wangxianming", "** setAlert id " + alarm.id + " atTime "
					+ atTimeInMillis);
		}
		...
		intent.putExtra("wokingtable", wokingtable);
		System.out.println("put intent wokingtable: "+wokingtable );
