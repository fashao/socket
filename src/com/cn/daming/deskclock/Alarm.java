...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        public static final String DEFAULT_SORT_ORDER =
                HOUR + ", " + MINUTES + " ASC";
        public static final String SORT_ID_ORDER =
                "socket ASC";
        ...
        static final String[] ALARM_QUERY_COLUMNS = {
            ...
            ENABLED, VIBRATE, MESSAGE, FLAG,SOCKET,ALERT };
        ...
        public static final int ALARM_FLAG_INDEX = 8;
        public static final int ALARM_SOCKET_INDEX = 9;
    ...
    public Alarm(Cursor c) {
        ...
        socket = c.getInt(Columns.ALARM_SOCKET_INDEX);
        String alertString = c.getString(Columns.ALARM_ALERT_INDEX);
        System.out.println("alertString :"+alertString);
    ...
    //创建一个默认当前时间的闹钟
    public Alarm(Context context,int socket) {
        id = -1;
